...
plot_homgame_importance <- function(baseimp, topvariables, title) {
  ...
  plot(base_arm, type = "b", ylim = c(min-0.5,max+0.5), xaxt="n", 
       ylab = "Importance", xlab = "Variable Name",pch = 15, main = title);
  ...
  legend("topright", legend=c("SOIL-ARM", "SOIL-BIC", "RF1", "RF2"), 
