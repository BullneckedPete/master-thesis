...
BGS_soil_bic <- round(SOIL(x, y, weight_type = "BIC", method = "union", candidate_models = t(candidate_models))$importance, 3)
...
BARDET_soil_bic <- round(SOIL(x, y, weight_type = "BIC", method = "union", candidate_models = t(candidate_models))$importance, 3)
